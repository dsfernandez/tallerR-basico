...
Puedes abrir un archivo de comandos vacío, o _script file_, haciendo clic en __File__, en el menú principal, y seleccionando __New File__, y __R Script__; alternativamente, puedes abrir el menú de archivos, haciendo clic en la cruz blanca ![](./media/white_cross.jpg){#id .class width=16 height=16px} al extremo izquierdo, arriba, en el panel de RStudio.
