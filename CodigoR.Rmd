---
title: "Creación y Edición de Código R"
output:
  html_document
---
...
# 1.4. Creación y Edición de Código R  
...
Puedes abrir un archivo de comandos vacío, o _script file_, haciendo clic en __File__, en el menú principal, y seleccionando __New File__, y __R Script__; alternativamente, puedes abrir el menú de archivos, haciendo clic en la cruz blanca __XXX__ al extremo izquierdo, arriba, en el panel de RStudio.
...
### Gramática del lenguaje R  
> Algunas reglas de escritura de códigos R.
...
Vamos a empezar con algunas definiciones de términos.  En R, un __objeto__ es cualquier cosa que se puede asignar a una variable (en general: un nombre).  Esto incluye constantes, estructuras de datos, gráficas, funciones.  Todo objeto tiene un _mode_, que describe cómo se guarda el objeto, y una _class_, que indica cómo lo van a manejar las __funciones__.  Estas últimas contienen __argumentos__, que debemos definir para obtener los resultados esperados, aunque usualmente traen argumentos por defecto ( _default_).

__El símbolo #__ se utiliza para iniciar la escritura de texto, que no funcionará como código en el momento de ser procesado.  Es muy importante para documentar los códigos que se utilizan:
```{r eval=FALSE}
# este es un ejemplo de su uso
mean(c(3,5,7,4)) # la función mean calcula la media de un conjunto de números
```

__Nombre de objetos:__ el nombre de los objetos a los que se asignan valores, resultados de funciones, et c., no es recomendable que sean de las funciones del sistema (mean, list, c, sd, et c.).  Hay una lista de nombres reservados que no se pueden usar; para verlas puedes escribir __?reserved__ en la consola.  
...
#### Correr códigos R
> Obteniendo resultados con los códigos.  
...
Usarán el siguiente archivo R Script: [ejercicio-script.R](https://raw.githubusercontent.com/dsfernandez/tallerRbasico/master/ejercicio-script.R)
...
### 1.4.2. Otros archivos en R Studio  
__Al terminar esta sección podrás identificar y crear al menos dos nuevos tipos de archivos en R Studio__  

Al hacer clic en el ícono de la cruz blanca, extremo izquierdo, arriba, aparece un menú de diferentes tipos de archivos que se pueden crear en RStudio, además de R Script.  En este taller estaremos trabajando con tres de ellos:  

- archivos de texto, __Text File__  
- documento __R Markdown__, y  
- presentación, __R Presentation__\
